...
image:https://img.shields.io/github/package-json/v/edosrecki/google-cloud-redis-cli/master?color=blue&label=google-cloud-redis["google-cloud-redis CLI Version"]
image:https://img.shields.io/github/workflow/status/edosrecki/google-cloud-redis-cli/Continuous Integration["Build Status", link="https://github.com/edosrecki/google-cloud-redis-cli/actions"]
